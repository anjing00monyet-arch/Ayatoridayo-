%%writefile main.py
# Kaggle-submittable copy of submissions/candidate/main.py -- direct
# byte-for-byte copy, no inlining needed (candidate is already fully
# self-contained: only stdlib imports -- base64, copy, json, math, zlib).
# Do not edit this file directly; regenerate it from
# submissions/candidate/main.py if that changes (see submissions/README.md).
