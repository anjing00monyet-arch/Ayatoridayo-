"""Baseline: opponents/submission_29 verbatim (v21 tactical-memory agent).

v9 (our own economically-tuned reactive agent) was rejected as the base for
further work in favor of building directly on this real, stronger public
submission -- see reports/latest_analysis.md "Round 10" and
opponents/README.md for the reasoning and the head-to-head numbers.
`submissions/candidate/main.py` holds the same code plus an endgame
liquidation improvement; this file is the unmodified reference it's
measured against.
